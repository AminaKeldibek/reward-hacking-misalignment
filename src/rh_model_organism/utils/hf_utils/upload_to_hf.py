...
Decouples uploading from generation: run `python -m rh_model_organism.evals.generate_completions`
...
Run as a module:
    ...
    HF_TOKEN=hf_... python -m rh_model_organism.utils.hf_utils.upload_to_hf \
...
def main():
    ...
    print(f"  python -m rh_model_organism.evals.run_judge --hf-repo {args.hf_repo} \\")
