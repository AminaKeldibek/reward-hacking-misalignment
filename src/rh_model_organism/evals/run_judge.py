...
``.eval`` logs produced by rh_model_organism.evals.generate_completions (either from a local
...
Usage (judge completions previously pushed to HF):
    ...
    ANTHROPIC_API_KEY=sk-... python -m rh_model_organism.evals.run_judge \
...
Or judge a local completions dir directly:
    ...
    OPENROUTER_API_KEY=sk-... python -m rh_model_organism.evals.run_judge \
