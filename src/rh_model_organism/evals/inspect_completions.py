...
Examples:
    ...
    python -m rh_model_organism.evals.inspect_completions --log-file ~/Downloads/...betley-eval....eval

    # A whole local run dir, first 5 to terminal
    python -m rh_model_organism.evals.inspect_completions \
        --log-dir results/completions/test_20260610_131432 --limit 5

    # Pull from HF (needs huggingface_hub) and dump an HTML page
    HF_TOKEN=hf_... python -m rh_model_organism.evals.inspect_completions \
