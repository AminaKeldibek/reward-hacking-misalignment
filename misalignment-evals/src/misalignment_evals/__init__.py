...
alignment_faking_eval runs alongside them but is NOT in MGS: its metric is a compliance gap
...
from misalignment_evals.reports.mgs import MGSResult, compute_mgs, extract_misalignment_rate_from_eval_log
